package java_intermediates.groupexercise;
...
public class MenuOrdering {
    ...
    The program should allow the user to select items to order, and keep a tally of the total should
    be printed for the customer once they finish selecting their order
     */
